...
import { ConnectionType, getHasMetaMaskExtensionInstalled } from './connectors/connections'
...
export const ConnectionOptions = ({
  ...
  return (
    <div className="connectors">
      {activeConnectionType === null && getOptions(isConnectionActive)}
      {activeConnectionType !== null && (
        <Option
          isEnabled={true}
          isConnected={true}
          connectionType={activeConnectionType} // Utiliza la conexión activa
          onActivate={onActivate} // Solo queremos la opción de desactivar la conexión activa
          onDeactivate={onDeactivate}
        />
      )}
    </div>

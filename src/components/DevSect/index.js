...
const DevSect = () => {
  return (
    <section className="inline-flex w-4/5 px-10 py-4 flex-col top-1/4 md:w-2/3 justify-self-center custom-container">
      <h2 className="flex-1 text-4xl text-indigo-50 font-bold">Desarrollos</h2>
